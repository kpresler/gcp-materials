...
capital_name = gcp_instructor.upper() 
...
# In California and Maryland, fun is strictly prohibited
can_buy_a_flamethrower = state != "MD" and state != "CA" 
...
# You should have some sense of this already.  I can easily write 27/7 as a fraction, but 
# there is no way to write it (exactly) as a decimal.  I can get _damn_ close, 3.857142, 
# but not _exact_.  Same deal for decimals in base-2, although it manifests for different numbers. 
