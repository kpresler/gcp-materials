...
# hey look, you can call functions with different arguments
print(f"Is 37 positive? {pos1}")
print(f"Is -20 positive? {is_positive(-20)}")


# functions can have multiple parameters, representing the different pieces of 
